...
class Poker_Ranking_Traditional extends Poker_Ranking {
    ...
    getStrength(hand) {
        ...
        if (!isStraight && // Detect wheel straight
            cards[0].rank == Poker_Card_Rank.ACE &&
            cards[1].rank == Poker_Card_Rank.FIVE &&
            cards[2].rank == Poker_Card_Rank.FOUR &&
            cards[3].rank == Poker_Card_Rank.THREE &&
            cards[4].rank == Poker_Card_Rank.DEUCE
        ) {
            isStraight = true;

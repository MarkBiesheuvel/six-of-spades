...
Hand.prototype.isStraight = function () {
    ...
    if (!('isStraight' in this.cache)) {
        ...
        this.cache.isStraight =
            this.cards[0].valueOf() == (this.cards[1].valueOf() + 1) &&
            this.cards[1].valueOf() == (this.cards[2].valueOf() + 1) &&
            this.cards[2].valueOf() == (this.cards[3].valueOf() + 1) &&
            this.cards[3].valueOf() == (this.cards[4].valueOf() + 1);
